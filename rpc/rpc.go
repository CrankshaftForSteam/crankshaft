...
func HandleRpc(debugPort, serverPort string, plugins *plugins.Plugins, devMode bool, hub *ws.Hub, steamPath, dataDir, pluginsDir, authToken string) *rpc.Server {
	...
	server.RegisterService(inject.NewInjectService(debugPort, serverPort, plugins, devMode, steamPath, authToken, pluginsDir), "InjectService")
