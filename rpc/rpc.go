...
func HandleRpc(debugPort, serverPort string, plugins *plugins.Plugins, devMode bool, hub *ws.Hub, steamPath string, dataDir string, pluginsDir string) *rpc.Server {
