...
func Patch(debugPort string, serverPort string, steamPath string, cacheDir string, noCache bool) error {
	...
	return patchJS(path.Join(steamPath, "steamui"), debugPort, serverPort, cacheDir, noCache)
}
